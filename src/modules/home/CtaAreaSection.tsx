    ...
    <section className="flex flex-col lg:flex-row justify-between items-end">
      <div className="w-full lg:w-[41%]">
        <div className="flex items-center gap-1 md:gap-3 lg:gap-5 -rotate-[5.18deg]">
          ...
          <Image
            src={arrowIcon}
            alt="Arrow Icon | Nguyen Trong But"
            width={77.54}
            height={45.12}
            priority
        ...
        <p className="font-semibold text-[32px] md:text-[40px] lg:text-4xl lg:text-[64px] mt-8 md:mt-[46px] leading-tight">
          I&apos;m{" "}
          <b className="relative">
            frontend
            <span className="absolute bottom-1 lg:bottom-2.5 left-0 -z-10 w-full h-1/4 bg-[#FFC9F0]" />
          </b>{" "}
          web developer
        </p>
      </div>
      <div className="w-full lg:w-[42%] mt-6 md:mt-8 lg:mt-0">
        <p className="text-base md:text-lg lg:text-2xl leading-[140%] mb-[30px]">
          I build responsive and user-friendly web applications using{" "}
          <b>React</b>, <b>Next.js</b>, and modern frontend best practices.
        </p>
        <Link
          href="https://drive.google.com/file/d/1VlwniGihQklrngEPvPBA8rgR8CddDnPB/view"
          target="_blank"
        >
          <Button>
            Resume
