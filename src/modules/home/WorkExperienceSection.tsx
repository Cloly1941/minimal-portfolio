    ...
    <section className="mt-section">
      <div className="flex flex-col lg:flex-row justify-between">
        ...
        <div className="w-full lg:w-[26%] lg:pt-10">
          ...
          />
          <p className="mt-5 lg:mt-12 text-base lg:text-2xl leading-snug">
            I have worked as a Front-End Developer for 3 months.
          </p>
        </div>
        ...
        <ul className="w-full lg:w-[66%] lg:py-[65px] mt-[31px] lg:mt-0 flex flex-col gap-6 md:gap-8 lg:gap-[37px] lg:justify-center lg:items-center xl:border-black xl:border-[3px] rounded-md">
          {experiences.map((item) => (
            <li
              key={item.id}
              className="flex gap-4 md:gap-6 lg:gap-[37px] lg:px-8"
            >
              <div
                className={cn(
                  ...
                  "rounded-md border-2 flex-shrink-0",
                  item.bgClass,
                  item.borderClass,
                )}
              >
              ...
              <div>
                <h3 className="text-base md:text-xl lg:text-2xl truncate">
                  {item.title} at <b className="font-bold">{item.company}</b>
                </h3>
