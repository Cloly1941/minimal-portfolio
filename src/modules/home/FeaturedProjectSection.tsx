        ...
        <section className='mt-section-rotate'>
            <div className='flex flex-col xl:flex-row justify-between'>
                ...
                <div className='w-full xl:w-[24%] xl:pt-[130px]'>
                    ...
                    <p className='mt-5 xl:mt-12 text-base xl:text-2xl leading-snug'>Have <b>4</b> featured personal
                        projects</p>
                </div>
                        ...
                        >
                            ...
                            <div className="flex justify-between mt-4 xl:mt-5">
                                <Link href={project.href}
                                      className='font-title font-bold text-xl xl:text-[28px] w-[50%] line-clamp-2'>
                                    <h3>
                                        {project.title}
                                    </h3>
                                </Link>
